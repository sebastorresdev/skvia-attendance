...
using Skvia.Erp.Application.Features.Attendances.Commands.EndBreak;
using Skvia.Erp.Application.Features.Attendances.Commands.MobileClock;
using Skvia.Erp.Application.Features.Attendances.Commands.StartBreak;
using Skvia.Erp.Domain.Employees;
using Skvia.Erp.Domain.Workplaces;
using Skvia.Erp.Infrastructure.Data;
using Xunit;

namespace Skvia.Erp.Application.Tests.Features.Attendances;
