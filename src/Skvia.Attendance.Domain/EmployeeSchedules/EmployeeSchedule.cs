...
public class EmployeeSchedule : BaseEntity
{
    ...
    public static ErrorOr<EmployeeSchedule> CreateVacationDay(Guid employeeId, DateOnly date, Guid branchId)
        => Create(employeeId, date, branchId, ScheduleDayType.Vacation);
