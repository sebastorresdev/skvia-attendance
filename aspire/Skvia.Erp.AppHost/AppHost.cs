...
var database = postgresServer.AddDatabase("skvia-erp-db");

// 🚀 3. Agregamos el proyecto WebApi y le inyectamos la referencia de la base de datos
var api = builder.AddProject<Projects.Skvia_Erp_Api>("skvia-erp-api")
...
builder.AddNpmApp("skvia-erp-frontend", "../../../skvia-erp-frontend", scriptName: "start")
    .WithReference(api)
    .WaitFor(api)
